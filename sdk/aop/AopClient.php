...
use Exception;
use leohowl\sdk\aop\AopEncrypt;
use leohowl\sdk\aop\SignData;
use leohowl\sdk\aop\EncryptParseItem;
...
class AopClient
{
     ...
     * @return \leohowl\sdk\aop\提交表单HTML文本|string
     * @throws \Exception
     */
     ...
     * @param $responseContent
     * @param $responseJSON
     * @return \leohowl\sdk\aop\SignData
     */
     ...
     * @param $request
     * @param $responseContent
     * @return \leohowl\sdk\aop\EncryptParseItem|null
     */
     ...
     * @param $nodeName
     * @param $nodeIndex
     * @return \leohowl\sdk\aop\EncryptParseItem
     */
